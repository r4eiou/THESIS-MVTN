import pandas as pd
import numpy as np
# df1 = pd.read_csv('csv/NVGestures/normal.csv', header = None) # place your csv1 in df1

#df1[df1.columns.drop('A')]
o = pd.read_csv('csv/NVGestures/original.csv', header = None) 
df1 = pd.read_csv('csv/NVGestures/depth.csv', header = None) # place your csv1 in df1
df2 = pd.read_csv('csv/NVGestures/ir.csv', header = None) # place your csv2 in df2
df3 = pd.read_csv('csv/NVGestures/normal.csv', header = None) # place your csv2 in df2
df4 = pd.read_csv('csv/NVGestures/depthop.csv', header = None) # place your csv2 in df2
df5 = pd.read_csv('csv/NVGestures/rgb.csv', header = None) # place your csv2 in df2
#df2[df2.columns.drop('A')]
#df4 = pd.read_csv('csv/NVGestures/color.csv', header = None) 
...
#print(final_df)
with open('csv/NVGestures/depth_depthop_normal_ir_rgb.csv', 'a', newline='') as csvfile:
